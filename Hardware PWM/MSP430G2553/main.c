...
void initLEDS(void)
{
    L1DIR |= LED1; // sets led2 to output
    P1SEL |= LED1; // selects led2 to output timer signal
}
...
void  initTA0(void)
{
    ...
    TA0CTL = TASSEL_2 + MC_1; // sets timer A to up mode
}
...
__interrupt void Port_1(void)
{
    ...
    __delay_cycles(5000); // lazy deboune
